---
layout: history_with_toc
title: "<span style='color: #8B4513;'>History</span>"
permalink: /history/
author_profile: false 
---

<!--
*A collection of notes, resources, and links related to the history of mathematics, science, and education.*
-->
...
This page contains [links to] books and documents concerning mathematics in Australia and its international connections, pre 1788 to 2010 or so.
*Some of this material will soon be available from the [Australian Mathematical Society](https://austms.org.au/about-us/) website*
  


## Historical Documents

- **Cohen, Graeme**: [*Counting Australia In: The People, Organisations and Institutions of Australian Mathematics*](https://www.dropbox.com/scl/fi/5289wu3bt0gots7vd21xt/CAI_booklet.pdf?rlkey=e21onppgvb6q2q59y7apuhev9&dl=1), Sydney, Halstead Press (2006); 431 pages. Written on the occasion of the 50th anniversary of the founding of the Australian Mathematical Society. (Now out of copyright.)
...
- **Curtis, Stephen A.**: [*The History and Development of Mathematics Examinations in New South Wales at the end of Secondary Schooling between 1788 and 2010*](https://opus.lib.uts.edu.au/bitstream/10453/20385/2/02Whole.pdf), PhD thesis, University of Technology, Sydney (2011).
<div style="font-size: 0.8em; color: #555; line-height: 1.1;margin-top: -0.9em;"> 
...
- **Cohen, Graeme**: [*Mathematics in Australasia to 1900*](/history_math/Maths_in_Aust.pdf), Sydney, Halstead Press (2006). A historical survey of the development and spread of mathematics in Australia and neighboring regions up to the year 1900.
<div style="font-size: 0.8em; color: #555; line-height: 1.1; margin-top: -0.9em;">
...
- **Barber, Michael**: [*The UNSW Cadets: pioneers at the birth of a new university*](https://www.royalsoc.org.au/wp-content/uploads/2025/07/158-1-04Barber.pdf), Journal & Proceedings of the Royal Society of New South Wales, vol. 158, part 1, 2025, pp. 32–49.
<div style="font-size: 0.8em; color: #555; line-height: 1.1;margin-top: -0.9em;">
...
The syllabus options broadened under the new system, but arguably the main mathematics and science subjects were not treated in more depth. Indeed, for students doing mathematics at the top level, there were now two 3-hour exams, as opposed to four 3-hour exams, with a corresponding decrease in the amount of class time available for mathematics. See the previous analysis by Stephen Curtis.
There was a decrease in the amount of geometry taught, but more material on linear algebra, including matrices.

Here are the two upper level [Mathematics I](/files_from_ANU/LC%20Maths%20I%20Pass%20Exam.pdf) and [Mathematics II](/files_from_ANU/LC%20Maths%20II%20Pass%20Exam.pdf) papers from 1962
and the corresponding top level [Mathematics I Honours](/files_from_ANU/LC%20Maths%20I%20Honours%20Exam.pdf) and [Mathematics II Honours papers](/files_from_ANU/LC%20Maths%20II%20Honours%20Exam.pdf).
The latter was comparable in scope and difficulty to the Cambridge and Oxford entrance examinations. Here are [solutions and comments](/files_from_ANU/LC_Maths_II_Solns.pdf).
...
is organised by the School of Mathematics and Statistics at the University of New South Wales. The "Problems and Solutions" go back only to 2005.
...
### SUMS
The Sydney University Mathematical Society [(SUMS) Competition](https://www.maths.usyd.edu.au/u/SUMSCOMP/) was an annual mathematics contest for undergraduate students, run by the University of Sydney, and first held in 1964. Students were given a month or so to work on the problems, with no restrictions on materials used other than another human being. The program ran until 2015, after which it was replaced by the [Simon Marais competition](https://www.simonmarais.org/). 

The SUMS site has problems and solutions for the years 
1998-2015.  Here are the problems and solutions for the first two years [1964](/history_math/SUMS_1964.pdf) and [1965](/history_math/SUMS_1965.pdf)
