...
<style>
/* Add space before the footnotes section */
.footnotes {
...
[*Introduction to Contemporary Mathematics*](/files_from_ANU/Contemporary Math.pdf) is the main text
 in a course for selected Years 11 and 12 college/high school students, which has been running since 2006.  There are four topics, two each year:
 * An introduction to number theory and RSA cryptography [^1]
 * The real number system, a hierarchy of infinities
 * fractals, chaotic behaviour;
 *  geometry and topology.

The philosophy of the course is discussed in the Introduction to the above text.

[^1]:The oﬃcial discoverers of RSA cryptography are three mathematicians Ron Rivest, Adi Shamir and Len Adleman, who published the method in 1977. However, another mathematician Cliﬀord Cocks, working for the British security agency, actually discovered the full method in 1973. For bureaucratic security reasons it was classified and not published, even though the British thought it did not have any use!



### Videos
Here are some videos I made for the course.  The first set is a short introduction and motivation for the course. 
Sets 2--5 develop RSA cryptography from scratch, with essentially no prerequisites. They follow the indicated sections from Chapter 2 in the above textbook, omitting material that is not relevant to RSA. 
<br>
1. [Introduction and Overview](https://www.youtube.com/playlist?list=PLoYM65JT1SUPPmh_VZBf4VfxcFUmxaJS1)  (6 videos, 21:58 minutes)
2. [Number Systems (Section 2.1)](https://www.youtube.com/playlist?list=PLoYM65JT1SUOZ1Xfcn_frWrSQQq5KjORm)  (one video, 5.27 minutes)
3. [Factorisations, Primes and Properties (Section 2.3)](https://www.youtube.com/playlist?list=PLoYM65JT1SUOcAtFPq1LJASnlNXaaNuLb)  (30 videos, approx 120 minutes)
...
To obtain an idea of what was done, and what could be done in future workshops, here are the [promotional flyers](/files_from_ANU/Teacher_Workshops.pdf).
...
Here is a [History of Mathematics Examinations](https://opus.lib.uts.edu.au/bitstream/10453/20385/2/02Whole.pdf) in New South Wales between 1788 and 2010!
...
[Mathematics I Pass Level 1962](/files_from_ANU/LC Maths I Pass Exam.pdf).<br>
[Mathematics II Pass Level 1962](/files_from_ANU/LC Maths II Pass Exam.pdf).<br>
[Mathematics I Honours Level 1962](/files_from_ANU/LC Maths I Honours Exam.pdf).<br>
[Mathematics II Honours Level 1962](/files_from_ANU/LC Maths II Honours Exam.pdf).
...
[Mathematics II Honours Level 1962, questions, solutions, comments](/files_from_ANU/LC_Maths_II_Solns.pdf).<br>
