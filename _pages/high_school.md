...
## Years 11, 12 Course:  Introduction to Contemporary Mathematics

### Text
*Introduction to Contemporary Mathematics* is the [main text](/files_from_ANU/Contemporary Math.pdf)
 ...
 * An introduction to number theory and RSA cryptography 
...
### Videos
Here are some relevant video "playlists". Playlists 2--5 develop RSA cryptography from scratch, with essentially no prerequisites. They follow the indicated sections from Chapter 2 in the above textbook, omitting any material that is not relevant for RSA.

1. [Introduction and Philosophy of the Course](https://www.youtube.com/playlist?list=PLoYM65JT1SUPPmh_VZBf4VfxcFUmxaJS1)
2. [Counting (Section 2.1)](https://www.youtube.com/playlist?list=PLoYM65JT1SUOZ1Xfcn_frWrSQQq5KjORm)
3. [Prime Numbers (Section 2.3](https://www.youtube.com/playlist?list=PLoYM65JT1SUOcAtFPq1LJASnlNXaaNuLb)
4. [Modular Arithmetic (Section 2.4)](https://www.youtube.com/playlist?list=PLoYM65JT1SUMxxjlbXWrdceM5KcvMKUG8)
5. [RSA Public Key Cryptography (Section 2.5)](https://www.youtube.com/playlist?list=PLoYM65JT1SUMLjymPFbFjdSrwZJhzTLZy)

### Final Days
 The last student intake for the ANU Extension Program was 2024 and the course will terminate at the end of 2025.[^1]  
...
[Mathematics II Honours Level 1962, questions, solutions, comments](/files_from_ANU/LC_Maths_II_Solns.pdf). 
