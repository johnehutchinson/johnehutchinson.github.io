...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   ...
   \includegraphics[width=5in]{V-vargenA.jpg} 
    \caption{\textbf{Convergent Process.} Organism growth from  initial cells.  Transformations rules interpreted as \emph{replacement/division}   rules.}
   \label{bp}
   \end{figure}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage \section{Convergent Process for Generating $ V $-Variable Trees}
...
\clearpage \section{Ergodic Process for Generating $ V $-Variable Fractals} \label{forp}
...
moves \emph{ergodically through} the set of   4-variable 4-tuple of sets.
  ...
  \begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   ...
   \caption{\textbf{Ergodic Process.} Transformations rules interpreted as \emph{combination}   rules.}
      \label{V-vargenB}
\end{figure}
...
\clearpage \section{Ergodic Process for Generating $ V $-Variable Trees} \label{forp}
...
A $ V $-tuple of labelled trees is generated at each step, from a $ V $-tuple of labelled trees at the previous step, by means of 
 transformation rules. 
  ...
  In Figure~\ref{V-treef} we have two IFSs, $ F $  for $ SG(2) $ and $ G $  for $ SG(3) $.  Since the branching number determines the IFS in this case, we do not explicitly show the IFS at the node for each transformation rule, nor at each node for the generated trees.
 
\bigskip We can think of each transformation rule as a method of combining trees at the previous level to obtain a tree at the current level.
...
Each limb is one of 4 possible types, and the subtree rooted at the top of the limb can also be regarded as of the same type.
  ...
  \begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   ...
   \caption{\textbf{Ergodic Process.} Transformations rules interpreted as \emph{combination}   rules.
   At the third level we only show the first  two of the four trees which are formed.}
      \label{V-treef}
\end{figure}
